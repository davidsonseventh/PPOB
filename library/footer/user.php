<?php 
// if(in_array($page, ['Ranking', 'Isi Saldo', 'Pilih Metode Pembayaran', 'Konfirmasi Deposit', 'Rincian Transaksi', 'Menunggu Pembayaran', 'Transfer Saldo', 'Konfirmasi Transfer', 'Pembayaran Berhasil', 'Syarat & Ketentuan', 'Kebijakan Privasi', 'Pusat Bantuan', 'Tentang Kami', 'Ubah Profil', 'Ganti PIN', 'Pemberitahuan', 'Kembali', 'Upgrade Level', 'Coming Soon', 'Daftar Harga', 'Login', 'Verifikasi OTP', 'Verifikasi PIN', 'Daftar', 'Detail Berita', 'Tarik Komisi', 'Konfirmasi Penarikan', 'Pulsa Reguler', 'Paket Internet', 'Games', 'Pulsa Transfer', 'E-Money', 'Token PLN', 'Voucher', 'Pascabayar', 'Aktivasi Voucher', 'Aktivasi Perdana']))
?>
<style>
...
<?php if(in_array($page, ['Dashboard', 'Akun Saya'])): ?>
    ...
    <div class="appBottomMenu app shadowed bg-white">
        ...
        <a href="<?= base_url('/shop'); ?>" class="item" style="opacity: 1; border-top: 0">
            <div class="col sp">
                <div class="bd">
                    <div class="action-button bg-primary">
                        <img src="<?= assets('images/icon/shop.svg') ?>" width="50px" height="50px">
                    </div>
                </div>
            </div>
        </a>
