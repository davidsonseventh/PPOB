    ...
    <div id="appCapsule" class="rgs-pending-deposit">
        <div class="section">
            ...
            <div class="form-button-group bg-primary">
                <a href="<?= base_url('deposit/invoice/'.$rows['rid']) ?>" class="btn rounded shadowed btn-block btn-lg">Lihat Status Pembayaran</a>
            </div>
            
            <div class="form-button-group bg-primary">
                 <button class="btn rounded shadowed btn-block btn-lg" onclick="goToHomePage()">Selesai</button>
</div>
<script>
function goToHomePage() {
    // Mengarahkan ke halaman awal tanpa menggunakan tautan
    const homePage = window.location.origin; // Mengambil origin dari URL saat ini
    window.location.href = homePage; // Mengarahkan pengguna ke halaman awal
}
</script>
            </div>
