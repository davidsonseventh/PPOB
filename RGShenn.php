...
$aiy = [
    'host' => 'localhost',
    'user' => 'user_database', # Username Database
    'pass' => 'masukkan_password_database', # Password Database
    'name' => 'nama_database'  # Nama Database
];
...
// -- |[ FLIP CONFIGURATION REQUIRED ]| -- //
require _DIR_('library/function/Flip.php');
$FLIP = new Flip([
    'username' => $call->query("SELECT * FROM provider WHERE code = 'FLIP'")->fetch_assoc()['uid'],
    'apikey' => $call->query("SELECT * FROM provider WHERE code = 'FLIP'")->fetch_assoc()['ukey']    
]);
