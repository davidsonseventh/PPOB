    ...
    <!-- App Capsule -->
            ...
            <div class="app-menu mt-3">
                ...
                <a href="<?= base_url('order/pulsa-international') ?>" class="item">
                    <div class="col">
                        ...
                        <strong>Pulsa Inter</strong>
                    </div>
                </a> 
                <a href="<?= base_url('order/e-money') ?>" class="item">
                    <div class="col">
                        <img src="<?= assets('mobile/icon/png/money.png') ?>" width="55px" height="55px">
        ...
        <div class="section full bg-white pl-1 pr-1 pb-3 mb-1">
            ...
            <div class="app-menu"> 
                ...
                <a href="<?= base_url('order/aktivasi-voucher') ?>" class="item">
                    <div class="col">
                        <img src="<?= assets('mobile/icon/png/voucher-data.png') ?>" width="55px" height="55px">
                        <strong>Inject Voucher</strong>
                    </div>
                     </a>
                <a href="<?= base_url('order/aktivasi-perdana') ?>" class="item">
                    <div class="col">
                        <img src="<?= assets('mobile/icon/png/act-perdana.png') ?>" width="55px" height="55px">
            ...
            <div class="app-menu">
                <a href="#"  class="item">
                 ...
                 <a href="#" onclick="toastbox('toastComingSoon', 2500)" class="item">
                    <div class="col">
                     <img src="<?= assets('mobile/icon/png/withdraw.png') ?>" width="55px" height="55px">
