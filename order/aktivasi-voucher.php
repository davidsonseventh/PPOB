...
require 'action.php';
$page = isset($_SESSION['success']) ? 'Pembayaran Berhasil' : 'Aktivasi Voucher';
                            ...
                            <div class="in">
                                <div class="form-group basic">
                                    <div class="input-wrapper">
                                        ...
                                        <input type="number" class="form-control" placeholder="Masukkan Nomor Vouher" name="data" id="data">
                                        <i class="input">
...
$(document).ready(function() {
    $("#data").keyup(function() {
        ...
        $.ajax({
            type: 'POST',
            data: 'data=' + target + '&type=aktivasi-voucher&csrf_token=<?= $csrf_string ?>',
