            ...
            <div class="card" style="border-radius: 5px !important; margin: 10px !important; padding:10px;box-shadow: 0 3px 6px 0 rgb(0 0 0 / 10%), 0 1px 3px 0 rgb(0 0 0 / 8%); ">
                <div class="menu-list" style="border-top: 0 color: #5f33ba; !important;">
                    <div class="app-menu mt-0">
                       ...
                       <a href="/premium/tarik-komisi.php" class="item">
                           <div class="col" style="font-size:10px">
                            <img src="/library/assets/images/header/tar.png" style="width: 30px;height: 30px;"><br/><br>Tarik Komisi
                           </div>
                       </a>
                ...
                <div class="alert alert-outline p-1 mt-2 mr-2 ml-2 pb-1 text-white" role="alert" style="border-radius: 50px; text-decoration: none;">
                    <div style="display: inline-flex; justify-content: space-between; align-items: center; width: 100%; backgroud: white;">
                        <div style="display: inline-flex; justify-content: space-between; align-items: center;">
                            <div class="icon">
                                <ion-icon name="notifications" style="font-size: 26px; padding-right: 12px; color: #5A24A8;"></ion-icon>
                            </div>
                            <div class="in">
                                <marquee scrollamount="10">
                             <font style = "font-size: 15px;color: #5A24A8;">  Hai Juragan! Kami informasikan pada saat ini proses maintenance telah selesai. Transaksi dan Topup Saldo telah kembali normal </font> 
	                            </marquee>
                            </div>
                        </div>
                    </div>
                    ...
                    <div style="display: inline-flex; justify-content: space-between; align-items: center; width: 100%;">
                        <div style="display: inline-flex; justify-content: space-between; align-items: center;">
                            ...
                            <div class="in">
                             ...
                             <font style = " font-size: 15px;"> <?= conf('text-marquee',c1) ?>  </font> 
	                            </marquee>
                            </div>
                        </div>
                    </div>
                            ...
                            <table class="table table-borderless bg-primary">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <p style="font-size:14px; color:white;">Bagikan kode referral supaya untung bareng teman-temanmu!
