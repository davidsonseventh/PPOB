                                ...
                                <div class="in">
                                    <div class="form-group basic">
                                        <div class="input-wrapper">
                                            ...
                                            <?php
                                            $search = $call->query("SELECT * FROM srv WHERE brand = '$brand' AND type = '$tipe' AND kategori NOT IN ('AlwaysOn') GROUP BY kategori ORDER BY kategori ASC");
...
$(document).ready(function() {
    $("#category").change(function() {
        ...
        $.ajax({
            type: 'POST',
            data: 'phone=' + data + '&kategori=' + category + '&type=aktivasi-perdana&csrf_token=<?= $csrf_string ?>',
